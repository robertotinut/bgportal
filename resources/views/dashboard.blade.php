...
@section('title', 'Dashboard | BGPortal Admin')
@section('title-sub', 'Dashboard')
@section('pagetitle', 'BGPortal Central')
@section('content')

    <!-- begin::App -->
    <div id="layout-wrapper">

        <!-- Central Applications Hub Section -->
        <div class="row mb-4">
            <div class="col-12">
                <div class="card bg-primary-subtle border-primary-subtle">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                            <div>
                                <h4 class="fw-bold mb-1 text-primary">Selamat datang, {{ Auth::user()->name }}! 👋</h4>
                                <p class="text-muted mb-0">Berikut adalah daftar aplikasi central yang terhubung dan dapat Anda akses.</p>
                            </div>
                            @if (Auth::user()->isAdmin())
                                <div class="d-flex gap-2">
                                    <a href="{{ route('admin.apps.index') }}" class="btn btn-primary btn-sm">
                                        <i class="bi bi-grid-fill me-1"></i> Kelola Aplikasi
                                    </a>
                                    <a href="{{ route('admin.app-access.index') }}" class="btn btn-outline-primary btn-sm">
                                        <i class="bi bi-shield-lock me-1"></i> Atur Hak Akses User
                                    </a>
                                </div>
                            @endif
                        </div>
                                        ...
                                        <div class="card-body p-4 d-flex flex-column justify-content-between">
                                            <div>
                                                <div class="d-flex align-items-center gap-3 mb-3">
                                                    <div class="h-48px w-48px rounded-3 bg-primary text-white d-flex align-items-center justify-content-center fs-3 flex-shrink-0">
                                                        <i class="{{ $app->icon ?? 'bi bi-app-indicator' }}"></i>
                                                    </div>
                                                    <div>
                                                        <h6 class="fw-bold mb-0 text-dark">{{ $app->name }}</h6>
                                                        <span class="badge bg-light text-muted border fs-11">Code: {{ $app->code }}</span>
                                                    </div>
                                                </div>
                                                <p class="text-muted fs-13 mb-3">{{ Str::limit($app->description, 70) }}</p>
                                            </div>
                                            <div>
                                                <a href="{{ $app->url }}" target="_blank" class="btn btn-outline-primary w-100 btn-sm d-flex align-items-center justify-content-center gap-1">
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-info mb-0">
                                        <i class="bi bi-info-circle me-2"></i> Anda saat ini belum memiliki akses ke aplikasi central manapun. Silakan hubungi Administrator.
                                    </div>
                                </div>
                            @endforelse
                        </div>
