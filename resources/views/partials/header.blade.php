            ...
            <div class="flex-shrink-0 d-flex align-items-center gap-1">
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    ...
                    <div class="dropdown-menu dropdown-mega-md header-dropdown-menu pe-noti-dropdown-menu p-0">
                        ...
                        <div class="p-3">
                            ...
                            <div class="noti-item">
                                <img src="{{ asset('assets/images/avatar/avatar-8.jpg') }}" alt="Avatar Image" class="avatar-md">
                                <div>
                                    <a href="javascript:void(0)" class="stretched-link">
                            ...
                            <div class="noti-item">
                                <img src="{{ asset('assets/images/avatar/avatar-6.jpg') }}" alt="Avatar Image" class="avatar-md">
                                <div>
                                    <a href="javascript:void(0)" class="stretched-link">
                                ...
                                <ul class="list-unstyled list-none mb-0 p-4" id="header-cart-items-scroll">
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/product/img-01.png') }}" class="avatar-md me-3" alt="img">
                                            <div class="flex-grow-1">
                                                <div>
                                    ...
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/product/img-02.png') }}" class="avatar-md me-3" alt="img">
                                            <div class="flex-grow-1">
                                                <div>
                                    ...
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/product/img-03.png') }}" class="avatar-md me-3" alt="img">
                                            <div class="flex-grow-1">
                                                <div>
                                    ...
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/product/img-04.png') }}" class="avatar-md me-3" alt="img">
                                            <div class="flex-grow-1">
                                                <div>
                                    ...
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/product/img-05.png') }}" class="avatar-md me-3" alt="img">
                                            <div class="flex-grow-1">
                                                <div>
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    <button class="btn btn-icon header-btn p-1" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset('assets/images/flag/us.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                    </button>
                    <ul class="dropdown-menu header-dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/es.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                Spanish
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/ru.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                French
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/de.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                German
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/cn.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                Chinese
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/sa.svg') }}" alt="Flag Image" height="16" width="16" class="object-fit-cover rounded">
                                Arabic
                            </a>
                        </li>
                    </ul>
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    <button class="header-profile-btn btn gap-1 text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="d-none d-lg-block pe-2">
                            <span class="d-block mb-0 fs-13 fw-semibold">{{ Auth::user()->name ?? 'Administrator' }}</span>
                            <span class="d-block mb-0 fs-12 text-muted">Administrator</span>
                        </div>
                    </button>
                    <div class="dropdown-menu dropdown-mega-sm header-dropdown-menu p-3">
                        <div class="border-bottom pb-2 mb-2 d-flex align-items-center gap-2">
                            ...
                            <div>
                                <a href="javascript:void(0)">
                                    <h6 class="mb-0 lh-base">{{ Auth::user()->name ?? 'Administrator' }}</h6>
                                </a>
                                <p class="mb-0 fs-13 text-muted">{{ Auth::user()->email ?? 'admin@bgportal.com' }}</p>
                            </div>
                        </div>
